...
const ViewMessages = ({
  ...
  // Fetch messages and user data on mount
  useEffect(() => {
  ...
  }, [userId, fetchMessagings, fetchUser]);
  ...
  }, [deleteMessaging, fetchMessagings]);
                      ...
                      <section className="replyStyle">
                        ...
                        {signups.map(user => (
                          <p className={styles.link} key={user.id}>
                            <Link
                              url={`/forms/reply/${id}/${userSent}/${encodeURIComponent(subject)}/${encodeURIComponent(message)}/${user.id}/${user.username}/${user.email}`}
                              title="Reply"
                            />
                          </p>
                        ))}
